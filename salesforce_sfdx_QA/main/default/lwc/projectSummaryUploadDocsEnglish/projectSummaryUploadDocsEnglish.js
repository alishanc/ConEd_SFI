...
import { OMNIDEF } from './projectSummaryUploadDocsEnglish_def.js';
import tmpl from './projectSummaryUploadDocsEnglish.html';
import tmpl_nds from './projectSummaryUploadDocsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class projectSummaryUploadDocsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
