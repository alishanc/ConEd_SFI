...
import { OMNIDEF } from './accountEligibilityEnglish_def.js';
import tmpl from './accountEligibilityEnglish.html';
import tmpl_nds from './accountEligibilityEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class accountEligibilityEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
