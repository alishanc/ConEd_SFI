...
import { OMNIDEF } from './supportHelpPageEnglish_def.js';
import tmpl from './supportHelpPageEnglish.html';
import tmpl_nds from './supportHelpPageEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class supportHelpPageEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
