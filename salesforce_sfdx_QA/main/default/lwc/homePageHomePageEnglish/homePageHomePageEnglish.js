...
import { OMNIDEF } from './homePageHomePageEnglish_def.js';
import tmpl from './homePageHomePageEnglish.html';
import tmpl_nds from './homePageHomePageEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class homePageHomePageEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
