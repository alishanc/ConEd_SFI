...
import { OMNIDEF } from './projectInspectionSchedulerEnglish_def.js';
import tmpl from './projectInspectionSchedulerEnglish.html';
import tmpl_nds from './projectInspectionSchedulerEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class projectInspectionSchedulerEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
