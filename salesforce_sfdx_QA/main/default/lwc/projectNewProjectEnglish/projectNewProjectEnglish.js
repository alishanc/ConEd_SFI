...
import { OMNIDEF } from './projectNewProjectEnglish_def.js';
import tmpl from './projectNewProjectEnglish.html';
import tmpl_nds from './projectNewProjectEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class projectNewProjectEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
