...
import { OMNIDEF } from './projectRevisionEnglish_def.js';
import tmpl from './projectRevisionEnglish.html';
import tmpl_nds from './projectRevisionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class projectRevisionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
