...
import { OMNIDEF } from './testProjectDataTableEnglish_def.js';
import tmpl from './testProjectDataTableEnglish.html';
import tmpl_nds from './testProjectDataTableEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class testProjectDataTableEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
