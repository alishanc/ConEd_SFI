...
import { OMNIDEF } from './accountRegistrationUpdateEnglish_def.js';
import tmpl from './accountRegistrationUpdateEnglish.html';
import tmpl_nds from './accountRegistrationUpdateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class accountRegistrationUpdateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
