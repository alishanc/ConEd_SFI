...
import { OMNIDEF } from './accountRegistrationEnglish_def.js';
import tmpl from './accountRegistrationEnglish.html';
import tmpl_nds from './accountRegistrationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class accountRegistrationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
