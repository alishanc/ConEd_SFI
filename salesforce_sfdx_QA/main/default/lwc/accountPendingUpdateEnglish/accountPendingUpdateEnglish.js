...
import { OMNIDEF } from './accountPendingUpdateEnglish_def.js';
import tmpl from './accountPendingUpdateEnglish.html';
import tmpl_nds from './accountPendingUpdateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class accountPendingUpdateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
