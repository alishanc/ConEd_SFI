...
import { OMNIDEF } from './estimateCreationFlowEnglish_def.js';
import tmpl from './estimateCreationFlowEnglish.html';
import tmpl_nds from './estimateCreationFlowEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class estimateCreationFlowEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
