...
import { OMNIDEF } from './homePageUnAuthenticatedEnglish_def.js';
import tmpl from './homePageUnAuthenticatedEnglish.html';
import tmpl_nds from './homePageUnAuthenticatedEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class homePageUnAuthenticatedEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
