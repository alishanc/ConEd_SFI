...
import { OMNIDEF } from './homePageLoggedInEnglish_def.js';
import tmpl from './homePageLoggedInEnglish.html';
import tmpl_nds from './homePageLoggedInEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class homePageLoggedInEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
