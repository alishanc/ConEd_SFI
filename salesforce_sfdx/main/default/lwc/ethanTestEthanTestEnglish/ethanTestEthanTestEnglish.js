...
import { OMNIDEF } from './ethanTestEthanTestEnglish_def.js';
import tmpl from './ethanTestEthanTestEnglish.html';
import tmpl_nds from './ethanTestEthanTestEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class ethanTestEthanTestEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
