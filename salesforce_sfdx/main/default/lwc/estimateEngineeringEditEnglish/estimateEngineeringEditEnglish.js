...
import { OMNIDEF } from './estimateEngineeringEditEnglish_def.js';
import tmpl from './estimateEngineeringEditEnglish.html';
import tmpl_nds from './estimateEngineeringEditEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class estimateEngineeringEditEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
