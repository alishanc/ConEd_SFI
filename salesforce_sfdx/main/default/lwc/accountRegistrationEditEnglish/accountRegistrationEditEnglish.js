...
import { OMNIDEF } from './accountRegistrationEditEnglish_def.js';
import tmpl from './accountRegistrationEditEnglish.html';
import tmpl_nds from './accountRegistrationEditEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class accountRegistrationEditEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
