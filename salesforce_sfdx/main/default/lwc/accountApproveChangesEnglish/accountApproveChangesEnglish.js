...
import { OMNIDEF } from './accountApproveChangesEnglish_def.js';
import tmpl from './accountApproveChangesEnglish.html';
import tmpl_nds from './accountApproveChangesEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class accountApproveChangesEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
